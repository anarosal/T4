   ...
   for(int i = 0; i < FRASES; i++){
    ...
    while(1)
    {
        ...
        if(redraw && al_is_event_queue_empty(queue))
        {
            ...
            al_draw_text(font, al_map_rgb(255, 0, 0), x[0], 50, 1, "FASE 3");
            al_draw_text(font, al_map_rgb(0, 0, 0), x[1], 150, 1, "MATE 500 ZUMBIS");
            al_draw_bitmap(zumbi, x[1]-120, 190, 0);
            al_draw_bitmap(zumbi, x[1]-40, 190, 0);
            al_draw_bitmap(zumbi, x[1]+40, 190, 0);
            al_draw_text(font, al_map_rgb(0, 0, 0), x[2], 340, 1, "VOCÊ TEM 1 VIDA");
            al_draw_bitmap(heart, x[2]-30, 380, 0);
            al_draw_text(font, al_map_rgb(0, 0, 0), x[3], 490, 1, "CONSIGA ÁCIDO SULFÚRICO");
            al_draw_bitmap(acido, x[3]-25, 530, 0);
