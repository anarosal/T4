   ...
   for(int i = 0; i < FRASES; i++){
    ...
    while(1)
    {
        ...
        if(redraw && al_is_event_queue_empty(queue))
        {
            ...
            al_draw_text(font, al_map_rgb(255, 0, 0), x[0], 50, 1, "FASE 2");
            al_draw_text(font, al_map_rgb(0, 0, 0), x[1], 150, 1, "MATE 300 ZUMBIS");
            al_draw_bitmap(zumbi, x[1]-80, 190, 0);
            al_draw_bitmap(zumbi, x[1], 190, 0);
            al_draw_text(font, al_map_rgb(0, 0, 0), x[2], 340, 1, "VOCÊ TEM 2 VIDAS");
            al_draw_bitmap(heart, x[2], 380, 0);
            al_draw_bitmap(heart, x[2]-60, 380, 0);
            al_draw_text(font, al_map_rgb(0, 0, 0), x[3], 490, 1, "CONSIGA PROPENO");
            al_draw_bitmap(propeno, x[3]-25, 530, 0);
            al_draw_text(font, al_map_rgb(255, 0, 0), x[4], 622, 1, "BOA SORTE !");
